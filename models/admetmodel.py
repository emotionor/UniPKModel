...
def train_admet_epoch(dataloader, config, optimizer, scheduler, admet_encoder, admet_head,scaler=None, device=None, writer=None, epoch=0):
...
def validate_admet_epoch(dataloader, config, admet_encoder, admet_head, device=None, writer=None, epoch=0):
    loss_fn = config.get('loss_fn', None)
    loss_alpha = config.get('loss_alpha', 1)
...
def admet_decorate_torch_batch(net_inputs, device=None):
    # net_inputs_pk = {
